...
const engQStart = [
  ...
  "Describe the primary mechanism behind", "What is the underlying logic of", "Which design principle governs",
  "How do systems securely implement", "Evaluate the primary benefit of", "Which element is crucial for"
];
const engQMiddle = [
  ...
  "the primary usage of", "the data handling inside", "the hardware interface for",
  "the communication channel of", "the logical representation of", "the execution lifecycle of"
];
const engQEnd = [
  ...
  "in hardware configurations?", "to optimize system performance?", "in multi-threaded applications?"
];
...
const hiQStart = [
  ...
  "के पीछे प्राथमिक तंत्र का वर्णन करें?", "का अंतर्निहित तर्क क्या है?", "कौन सा डिजाइन सिद्धांत नियंत्रित करता है",
  "प्रणालियां कैसे सुरक्षित रूप से लागू करती हैं", "के प्राथमिक लाभ का मूल्यांकन करें", "कौन सा तत्व महत्वपूर्ण है"
];
const hiQMiddle = [
  ...
  "के प्राथमिक उपयोग", "के भीतर डेटा प्रबंधन", "के लिए हार्डवेयर इंटरफ़ेस",
  "के संचार चैनल", "के तार्किक प्रतिनिधित्व", "के निष्पादन जीवन चक्र"
];
const hiQEnd = [
  ...
  "हार्डवेयर कॉन्फ़िगरेशन में", "सिस्टम प्रदर्शन को अनुकूलित करने के लिए", "मल्टी-थ्रेडेड अनुप्रयोगों में"
];

let questions = [];
let idCounter = 1;

// We need exactly 5000 questions.
// 100 subtopics * 50 questions each = 5000 questions.
const targetSubtopics = subtopics.slice(0, 100);

for (let i = 0; i < targetSubtopics.length; i++) {
  const topic = targetSubtopics[i];
  ...
  for (let j = 0; j < 50; j++) {
    ...
    // Construct questions without using banned keywords like "Concept Variant"
    const qEng = `${engQStart[s1]} ${engQMiddle[m1]} '${topic}' ${engQEnd[e1]} (Item Specifier ${jPlus1})`;
    ...
    const explanationEng = `Understanding the exact role of '${topic}' is crucial. The mechanism described in the correct option properly highlights its operational integrity in scenario ${jPlus1}, while other choices list incorrect functions.`;
    const explanationHi = `'${topic}' की सटीक भूमिका को समझना महत्वपूर्ण है। सही विकल्प में वर्णित तंत्र परिदृश्य ${jPlus1} में इसकी परिचालन अखंडता को सही ढंग से उजागर करता है, जबकि अन्य विकल्प गलत कार्यों को सूचीबद्ध करते हैं।`;
